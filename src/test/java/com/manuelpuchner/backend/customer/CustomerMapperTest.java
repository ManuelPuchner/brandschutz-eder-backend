...
class CustomerMapperTest {
    ...
    void toCustomer_givenDto_thenMapsAllFieldsWithoutCoordinates() {
        CreateCustomerDTO dto = buildDto("Alice", "Austria", "4040", "Hauptstraße 1", "+431234");
    ...
    @Test
    void toCustomer_givenDtoAndCoords_thenMapsAllFieldsIncludingCoordinates() {
        CreateCustomerDTO dto = buildDto("Alice", "Austria", "4040", "Hauptstraße 1", "+431234");
    ...
    void toDto_givenCustomerWithCoordinates_thenMapsAllFields() {
        Customer customer = buildCustomer(1L, "Alice", "Austria", "4040", 48.3, 14.2);
    ...
    @Test
    void toDto_givenCustomerWithoutCoordinates_thenLatLonAreNull() {
        Customer customer = buildCustomer(2L, "Bob", "Germany", "10115", null, null);
    ...
    private CreateCustomerDTO buildDto(String name, String country, String postalcode,
    ...
    private Customer buildCustomer(Long id, String name, String country,
